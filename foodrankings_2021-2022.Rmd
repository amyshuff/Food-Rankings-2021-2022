...
District scores were calculated as follows:\
  25% percent of lunch participation\
  50% percent of Breakfast participation\
  10% serving supper\
...
`r sum(tea$tea.all.stud, na.rm = T)` number of students that qualify for free meals

top ranking districts participation rates

lowest ranking districts participation rates

Top 10 school districts overall

top 5 large school districts

top 5 middle-income school districts

district with the highest lunch participation
district with the highest breakfast participation

percent of districts that participate in the CACFP after-school meal program
