...
totalstudents <- sum(tea$tea.all.stud, na.rm = T) %>% 
  format(big.mark=",")

#topten <- ifelse(district_rankings$"Rank" %in% 1:10, district_rankings"District Name", "")

#topten <- paste(district_rankings$"District Name", collapse = ', '

#`r arrange(-district_rankings$"% Lunch Participation"), first(district_rankings$"District Name")`
#`r paste(district_rankings$"District Name", collapse = ', ')`
```

All `r totalstudents` students in Texas were offered free meals this year.
...
Top 10 school districts overall: Clint ISD, Donna ISD, IDEA Academy, Harlandale ISD, McAllen ISD, Eagle Pass ISD, La Joya ISD, Edinburg ISD, San Antonio ISD, Harlingen Consolidated ISD
...
District with the highest lunch participation: Los Fresnos Consolidated ISD, with `r max(district_rankings$"% Lunch Participation")`% of their total student population participating in lunch 
...
* [Meal and Reimbursement Data, Program Years 2015-2021](https://data.texas.gov/stories/s/e2dm-5r4v)
